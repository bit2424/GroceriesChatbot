...
dataset_name = "nelson2424/Grocery_chatbot_text_v2"
checkpoint_name = "grocery_action_classifier_v2.pt"
text_column = "text"
...
wandb.init(
    ...
    project="Groceries_classification_v2",
...
model.push_to_hub("nelson2424/mt0-small-lora-finetune-grocery-action-classifier-v2")
